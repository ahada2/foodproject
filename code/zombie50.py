...
image_dir = 'E:/project/food101-tensorflow/train50' #change
image_size = (100, 100)
batch_size = 128
#epochs = 1
...
steps_per_epoch = (int)(num_of_classes * 1000) / batch_size
validation_steps = steps_per_epoch

history = classifier.fit_generator(train_generator, steps_per_epoch, epochs = 70, validation_data = Validation, validation_steps = validation_steps)
classifier.summary()
# Save the model after training
classifier.save('E:/project/test_models/50class70epoch.h5') #change
...
# Testing
#change
food_classes = ["apple_pie","baby_back_ribs","baklava","breakfast_burrito","cheesecake","cheese_plate","chicken_quesadilla","chicken_wings","clam_chowder","cup_cakes","deviled_eggs","donuts","edamame","eggs_benedict","escargots","falafel","fish_and_chips","french_onion_soup","french_toast","fried_rice","garlic_bread","gnocchi","greek_salad","hamburger","hot_dog","hummus","ice_cream","lasagna","lobster_bisque","macaroni_and_cheese","nachos","omelette","onion_rings","oysters","pad_thai","pancakes","panna_cotta","peking_duck","pho","pizza","pulled_pork_sandwich","ravioli","samosa","shrimp_and_grits","spaghetti_carbonara","spring_rolls","steak","sushi","tacos","takoyaki"]

classes_folder = "E:/project/food101-tensorflow/train50/" #change
...
for i in range(10):
    ...
    # Load image
    img = load_img(image_test, target_size=(100, 100))
